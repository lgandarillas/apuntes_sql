...
-- Vulgarmente, "stored procedures" son queries que guardamos en "favoritos"

-- Crea un procedimiento almacenado llamado "p_all_users" que obtiene todos los datos de la tabla "users"
DELIMITER //
...
-- obtener usuarios con una edad variable
DELIMITER //
