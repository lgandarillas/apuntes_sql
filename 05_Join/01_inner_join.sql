...
-- INNER JOIN sirve para obtener los datos comunes a dos tablas.
-- Obtiene los datos coincidentes de los usuarios que tienen un dni.
-- Retorna las filas de dos o más tablas cuando hay coincidencias.
SELECT * FROM users
INNER JOIN dni
ON users.user_id = dni.user_id;

-- Obtiene los datos de los usuarios que tienen un dni
-- (JOIN es lo mismo que INNER JOIN en muchos motores de ddbb)
SELECT * FROM users
JOIN dni
ON users.user_id = dni.user_id;
